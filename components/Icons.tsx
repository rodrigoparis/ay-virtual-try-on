...
export const NikeLogo: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 290 120" fill="currentColor" {...props}>
    <path d="M282.6,1.4C213-10,137.9,13.2,85.2,50.1C41.2,80.1,4.7,103.2,0,105.3c3.6-0.8,7.3-1.8,11-2.9 c40.4-12,81.3-24.8,121.1-27.2c39.2-2.4,79.5,5.2,116.3,21.3c1.3,0.6,2.6,1.1,3.9,1.7c5.2,2.3,10.5,4,16.2,4.8 C278.4,105.1,288.5,60.6,282.6,1.4z" />
  </svg>
);
